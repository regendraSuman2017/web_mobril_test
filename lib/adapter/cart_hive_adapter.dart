...
class CartAdapter extends TypeAdapter<GetAllProductResponse> {
  @override
  GetAllProductResponse read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, GetAllProductResponse obj) {
    writer
      ..writeByte(0)
      ..write(obj.id)
      ..writeByte(1)
